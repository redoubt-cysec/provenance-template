...
$versionContent | Out-File -FilePath "$manifestDir/redoubt-cysec.ProvenanceDemo.yaml" -Encoding UTF8 -NoNewline
...
$installerContent | Out-File -FilePath "$manifestDir/redoubt-cysec.ProvenanceDemo.installer.yaml" -Encoding UTF8 -NoNewline
...
$localeContent | Out-File -FilePath "$manifestDir/redoubt-cysec.ProvenanceDemo.locale.en-US.yaml" -Encoding UTF8 -NoNewline
...
Write-Host "  2. Copy $manifestDir to manifests/r/redoubt-cysec/ProvenanceDemo/$versionNoV/" -ForegroundColor White
